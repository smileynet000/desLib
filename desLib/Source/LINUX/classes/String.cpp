...
char & String::operator[](unsigned long offset)
{
 return str[offset];
}

char String::operator[](unsigned long offset) const
{
 return str[offset];
}
...
unsigned long String::begin()
{
 return 0;
}

unsigned long String::end()
{
 return length();
}

unsigned long String::rbegin()
{
 return end();
}

unsigned long String::rend()
{
 return begin();
}
...
void String::from_long(unsigned long l)
{
 switch (l)
 {
  case 0:
...
void String::insert(unsigned long offset, char d)
{
 unsigned long len;
...
void String::remove(unsigned long offset)
{
 unsigned long len;
